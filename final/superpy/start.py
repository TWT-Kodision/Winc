...
if args.function == 'expired_list':
    result = get_expired_product_list()
    print_list(result)
if args.function == 'date_range':
    result = get_products_date_range(args.start_date, args.end_date, args.bought_sold)
    print_list(result)
...
if args.function == 'plot_sold_graph':
    make_date_sold_graph(args.start_date, args.end_date)
if args.function == 'add_bought':
    register_bought_product(args.id, args.name, args.buy_date, args.buy_price, args.expiration_date)
    print("product added to bought list")
if args.function == 'add_sold':
    register_sold_product(args.id, args.bought_id, args.sell_date, args.sell_price)
